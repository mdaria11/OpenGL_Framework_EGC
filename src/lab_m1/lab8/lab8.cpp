...
void Lab8::Init()
{
    ...
    {
        VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(1,0,0), glm::vec3(0, 1, 1)), //0
        VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1,0,0), glm::vec3(0, 1, 1)), //1
        VertexFormat(glm::vec3(1, 0, -1), glm::vec3(1,0,0), glm::vec3(0, 1, 1)), //2
        VertexFormat(glm::vec3(-1, 0, -1), glm::vec3(1,0,0), glm::vec3(0, 1, 1)), //3
    };
    ...
    CreateMesh("quad", vertices, indices);
}

//function that creates a mesh
Mesh* Lab8::CreateMesh(const char* name, const std::vector<VertexFormat>& vertices, const std::vector<unsigned int>& indices)
{
    unsigned int VAO = 0;
...
void Lab8::Update(float deltaTimeSeconds)
{
    ...
    */
    ...
    RenderSimpleMesh(meshes["quad"], shaders["LabShader"], glm::mat4(1));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform3fv(light_position2, 1, glm::value_ptr(glm::vec3(2, 2, 0)));

    int light_direction2 = glGetUniformLocation(shader->program, "light_direction2");
    glUniform3fv(light_direction2, 1, glm::value_ptr(glm::vec3(0, -1, 0)));
    ...
    int spotonloc = glGetUniformLocation(shader->program, "spoton");
    glUniform1i(spotonloc, spoton);
