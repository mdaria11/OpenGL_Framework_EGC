...
void Lab3_Vis2D::OnInputUpdate(float deltaTime, int mods)
{
    ...
    {
        logicSpace.y = logicSpace.y + speed * deltaTime;
    }
    if (window->KeyHold(GLFW_KEY_A))
    {
        logicSpace.x = logicSpace.x - speed * deltaTime;
    }
    ...
    {
        logicSpace.x = logicSpace.x - speed * deltaTime / 2;
        logicSpace.y = logicSpace.y - speed * deltaTime / 2;
        logicSpace.width = logicSpace.width + speed * deltaTime;
        logicSpace.height = logicSpace.height + speed * deltaTime;
    }
