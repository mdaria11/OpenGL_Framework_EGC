...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //3
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //4
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //5
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //6
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //7
        ...
        vector<VertexFormat> verticestetra
        {
            ...
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(0, 0, -1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //3
        };
        ...
        vector<VertexFormat> verticesp
        {
            ...
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //3
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //4
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)) //5
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(3, 0, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square

    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(4, 0, 0), glm::vec3(5));
